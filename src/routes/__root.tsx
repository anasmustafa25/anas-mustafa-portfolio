...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Anas Mustafa — AI Engineer & Data Scientist building intelligent systems and turning data into insight." },
      { name: "author", content: "Anas Mustafa" },
